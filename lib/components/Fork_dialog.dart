...
///  * [showDialogF], which actually displays the dialog and returns its result.
///  * <https://material.io/design/components/dialogs.html>
class DialogFork extends StatelessWidget {
  /// Creates a dialog.
  ///
  /// Typically used in conjunction with [showDialogF].
  const DialogFork({
    Key key,
...
///
/// Typically passed as the child widget to [showDialogF], which displays the
/// dialog.
///
/// {@tool sample}
///
...
class SimpleDialogOption extends StatelessWidget {
  ...
  /// with a value for [showDialogF] to complete its future with.
...
/// options are represented as an enum. The [showDialogF] method here returns
...
///   switch (await showDialogF<Department>(
///     context: context,
///     builder: (BuildContext context) {
///       return SimpleDialog(
...
/// `showDialogF` is originally called from. Use a [StatefulBuilder] or a
